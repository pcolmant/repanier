...
# 5 20 * * 2 /home/repad/v1/ptidej/cron/ptidej_close_orders.sh >/dev/null 2>&1
...
export DJANGO_SETTINGS_MODULE_DATABASE_NAME=uptidej
...
/home/repad/v1/bin/python /home/repad/v1/ptidej/manage.py close_orders
