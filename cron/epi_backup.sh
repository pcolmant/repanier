...
export DJANGO_SETTINGS_MODULE=lepi.lepi_settings
export DJANGO_SETTINGS_MODULE_DEBUG=False
export DJANGO_SETTINGS_MODULE_DATABASE_NAME=ulepi
...
export DJANGO_SETTINGS_MODULE_ADMIN_NAME=lepi
export DJANGO_SETTINGS_MODULE_ADMIN_EMAIL=pcolmant@gmail.com
/home/repad/v1/bin/python /home/repad/v1/lepi/manage.py backup_db
