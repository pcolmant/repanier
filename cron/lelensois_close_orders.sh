...
export DJANGO_SETTINGS_MODULE=lelensois.lelensois_settings
export DJANGO_SETTINGS_MODULE_DEBUG=True
export DJANGO_SETTINGS_MODULE_DATABASE_NAME=ulelensois
...
export DJANGO_SETTINGS_MODULE_ADMIN_NAME=lelensois
export DJANGO_SETTINGS_MODULE_ADMIN_EMAIL=repanier-adm@repanier.be
/home/repad/v1/bin/python /home/repad/v1/lelensois/manage.py close_orders
