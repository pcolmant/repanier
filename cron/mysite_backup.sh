...
export DJANGO_SETTINGS_MODULE_DATABASE_NAME=urepanier
...
export DJANGO_SETTINGS_MODULE_ADMIN_NAME=repanier
export DJANGO_SETTINGS_MODULE_ADMIN_EMAIL=pcolmant@gmail.com
/home/repad/v1/bin/python /home/repad/v1/mysite/manage.py backup_db
