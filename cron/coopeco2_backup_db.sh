...
export DJANGO_SETTINGS_MODULE=coopeco2.coopeco2_settings
export DJANGO_SETTINGS_MODULE_DEBUG=False
export DJANGO_SETTINGS_MODULE_DATABASE_NAME=ucoopeco2
...
export DJANGO_SETTINGS_MODULE_ADMIN_NAME=coopeco2
export DJANGO_SETTINGS_MODULE_ADMIN_EMAIL=pcolmant@gmail.com
/home/repad/v1/bin/python /home/repad/v1/coopeco2/manage.py backup_db
