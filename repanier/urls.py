...
urlpatterns = [
    ...
    url(r'^order/(?P<permanence_id>\d+)/(?P<delivery_id>\d+)/$', never_cache(OrderView.as_view()), name='order_view'),
    url(r'^order/(?P<permanence_id>\d+)/$', never_cache(OrderView.as_view()), {'delivery_id': 0}, name='order_view'),
    ...
    url(r'^rest/permanence/(?P<permanence_id>\d+)/(?P<short_profile_name>.*)/(?P<reference>.*)/$',
        permanence_producer_product_rest,
        name='permanence_producer_product_rest'),
    url(r'^rest/permanence/(?P<permanence_id>\d+)/(?P<short_profile_name>.*)/$', permanence_producer_rest,
