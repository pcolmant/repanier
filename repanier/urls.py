...
urlpatterns = patterns('',
                       ...
                       url(r'^order/(\w+)/$', cache_page(2*24*60*60)(OrderView.as_view()), name='order_view'),
                       # url(r'^order/(\w+)/$', login_required(cache_page(2*24*60*60)(OrderView.as_view())), name='order_view'),
                       url(r'^basket/(\w+)/$', OrderViewWithoutCache.as_view(), name='basket_view'),
