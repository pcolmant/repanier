    ...
    def send_startup_email(cls, argv_0):
        if argv_0 == "uwsgi":  # Maybe better != manage.py',
            ...
            body = """
                        ...
                        REPANIER_SETTINGS_BOX : {REPANIER_SETTINGS_BOX}
                        REPANIER_SETTINGS_CONTRACT : {REPANIER_SETTINGS_CONTRACT}
                        ...
                        REPANIER_SETTINGS_PRE_OPENING : {REPANIER_SETTINGS_PRE_OPENING}
                        REPANIER_SETTINGS_PRODUCT_LABEL : {REPANIER_SETTINGS_PRODUCT_LABEL}
                        REPANIER_SETTINGS_PRODUCT_REFERENCE : {REPANIER_SETTINGS_PRODUCT_REFERENCE}
                ...
                REPANIER_SETTINGS_BOX=settings.REPANIER_SETTINGS_BOX,
                REPANIER_SETTINGS_CONTRACT=settings.REPANIER_SETTINGS_CONTRACT,
                ...
                REPANIER_SETTINGS_PRE_OPENING=settings.REPANIER_SETTINGS_PRE_OPENING,
                REPANIER_SETTINGS_PRODUCT_LABEL=settings.REPANIER_SETTINGS_PRODUCT_LABEL,
                REPANIER_SETTINGS_PRODUCT_REFERENCE=settings.REPANIER_SETTINGS_PRODUCT_REFERENCE,
