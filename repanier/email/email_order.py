...
def email_order(permanence_id, everything=True, deliveries_id=()):
    ...
    if not everything:
        ...
        if wb is not None:
            # At least one order
            order_staff_mail = config.order_staff_mail_v2
    ...
    for producer in producer_set:
        ...
        order_producer_mail = config.order_producer_mail_v2
...
def export_order_2_1_group(
    ...
    if wb is not None:
        ...
        order_customer_mail = config.order_customer_mail_v2
...
def export_order_2_1_customer(
    ...
    if customer_invoice is not None:
        ...
        if wb is not None:
            ...
            if cancel_order:
                order_customer_mail = config.cancel_order_customer_mail_v2
                order_customer_mail_subject = "{} - {} - {}".format(
                    _("⚠ Order cancelled"),
