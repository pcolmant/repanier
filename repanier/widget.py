...
class SelectAdminOrderUnitWidget(forms.Select):
    ...
    def render(self, name, value, attrs=None, choices=()):
        ...
        output.append('            django.jQuery("div.field-box.field-unit_deposit").show();')
        output.append('            django.jQuery("div.field-box.field-order_average_weight").hide();')
        output.append('            django.jQuery("div.field-box.field-customer_minimum_order_quantity").show();')
        output.append('            django.jQuery("div.field-box.field-customer_increment_order_quantity").show();')
        output.append('            django.jQuery("div.field-box.field-customer_alert_order_quantity").show();')
        output.append('            django.jQuery("div.field-box.field-customer_unit_price").show();')
        output.append('            django.jQuery("div.field-box.field-wrapped").show();')
        output.append('            break;')
        output.append('        case "105":')
        output.append('        case "110":')
        output.append('        case "115":')
        output.append('            django.jQuery("div.field-box.field-unit_deposit").show();')
        output.append('            django.jQuery("div.field-box.field-order_average_weight").show();')
        output.append('            django.jQuery("div.field-box.field-order_average_weight").show();')
        output.append('            django.jQuery("div.field-box.field-customer_minimum_order_quantity").show();')
        output.append('            django.jQuery("div.field-box.field-customer_alert_order_quantity").show();')
        output.append('            django.jQuery("div.field-box.field-customer_unit_price").show();')
        ...
        output.append('            django.jQuery("div.field-box.field-unit_deposit").hide();')
        output.append('            django.jQuery("div.field-box.field-order_average_weight").show();')
        output.append('            django.jQuery("div.field-box.field-customer_minimum_order_quantity").show();')
        output.append('            django.jQuery("div.field-box.field-customer_increment_order_quantity").show();')
        output.append('            django.jQuery("div.field-box.field-customer_alert_order_quantity").show();')
        ...
        output.append('            django.jQuery("div.field-box.field-unit_deposit").hide();')
        output.append('            django.jQuery("div.field-box.field-order_average_weight").hide();')
        output.append('            django.jQuery("div.field-box.field-customer_minimum_order_quantity").hide();')
        output.append('            django.jQuery("div.field-box.field-customer_increment_order_quantity").hide();')
        output.append('            django.jQuery("div.field-box.field-customer_alert_order_quantity").hide();')
        output.append('            django.jQuery("div.field-box.field-customer_unit_price").hide();')
        output.append('            django.jQuery("div.field-box.field-wrapped").hide();')
        output.append('            break;')
        output.append('    }')
        output.append('    switch (value) {')
        output.append('        case "105":')
        output.append('            django.jQuery("div.field-box.field-order_average_weight label").html("%s");'
        ...
        output.append('        case "105":')
        output.append('        case "110":')
        output.append('            django.jQuery("div.field-box.field-producer_unit_price label").html("%s");'
                      % _("Producer price for one piece"))
        output.append('            django.jQuery("div.field-box.field-customer_unit_price label").html("%s");'
