...
from repanier.models import PurchaseWoReceiver, OfferItemWoReceiver, CustomerInvoice, ProducerInvoice, \
    ...
    def handle(self, *args, **options):
        ...
        for permanence_id in options['permanence_id']:
            for permanence in Permanence.objects.filter(
                ...
                self.stdout.write(self.style.SUCCESS("Successfully deleted permanence '{}'".format(permanence)))
