...
from repanier_v2.picture.const import SIZE_XS
...
class DispensingPoint(MPTTModel):
    parent = TreeForeignKey(
        "self", null=True, blank=True, related_name="children", on_delete=models.CASCADE
    )
    short_name = models.CharField(_("Short name"), max_length=50, default=EMPTY_STRING)
    ...
    transport = ModelMoneyField(
        _("Dispensing point shipping cost"),
        default=DECIMAL_ZERO,
        blank=True,
        max_digits=5,
        decimal_places=2,
    ...
    class Meta:
        verbose_name = _("Dispensing point")
        verbose_name_plural = _("Dispensings points")
        db_table = "repanier_dsp_point"
