...
from repanier_v2.widget.money import MoneyWidget
...
class RepanierMoney(object):
    ...
    def __str__(self):
        ...
        # Suffix currency
        if repanier_v2.globals.REPANIER_SETTINGS_AFTER_AMOUNT:
            build(" {}".format(repanier_v2.globals.REPANIER_SETTINGS_CURRENCY_DISPLAY))
        ...
        # Prefix currency
        if not repanier_v2.globals.REPANIER_SETTINGS_AFTER_AMOUNT:
            build("{}".format(repanier_v2.globals.REPANIER_SETTINGS_CURRENCY_DISPLAY))
