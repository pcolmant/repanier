...
class OrderTaskInline(InlineForeignKeyCacheMixin, admin.TabularInline):
    model = OrderTask
    ordering = [
...
class OrderClosedForm(forms.ModelForm):
...
class OrderClosedAdmin(RepanierAdmin):
    form = OrderClosedForm
    ...
    def get_list_display(self, request):
        list_display = ["get_order_admin_display", "get_row_actions"]
