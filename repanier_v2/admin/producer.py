...
from repanier_v2.admin.forms import ImportStockForm
from repanier_v2.admin.tools import check_cancel_in_post
from repanier_v2.const import ORDER_PLANNED, DECIMAL_ONE, DECIMAL_ZERO, EMPTY_STRING
from repanier_v2.impexport.producer import ProducerResource
from repanier_v2.middleware import get_query_filters
...
from repanier_v2.tools import web_services_activated
from repanier_v2.xlsx.views import import_xslx_view
from repanier_v2.xlsx.xlsx_invoice import export_invoice
from repanier_v2.xlsx.xlsx_product import export_customer_prices
from repanier_v2.xlsx.xlsx_stock import handle_uploaded_stock, export_producer_stock
...
class ProducerDataForm(forms.ModelForm):
    permanences = forms.ModelMultipleChoiceField(
        Permanence.objects.filter(status=ORDER_PLANNED),
        label="{}".format(_("Sale")),
        widget=FilteredSelectMultiple(
            repanier_v2.globals.REPANIER_SETTINGS_ORDER_ON_NAME, False
        ),
        required=False,
    )
