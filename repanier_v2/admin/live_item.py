...
from repanier_v2.models import LiveItem
...
from repanier_v2.admin.tools import check_cancel_in_post, check_product
...
from repanier_v2.middleware import add_filter, get_query_filters, get_query_params
from repanier_v2.models.lut import LUT_DepartmentForCustomer, LUT_ProductionMode
from repanier_v2.models.producer import Producer
from repanier_v2.models.product import Product
from repanier_v2.task import task_product
from repanier_v2.tools import (
    update_offer_item,
    get_repanier_template_name,
    get_repanier_static_name,
)
from repanier_v2.widget.select_admin_order_unit import SelectAdminOrderUnitWidget
...
class LiveItemResource(resources.ModelResource):
...
class LiveItemDataForm(forms.ModelForm):
    def clean(self):
        if any(self.errors):
...
class LiveItemAdmin(RepanierAdminImportExport):
    ...
    def get_form(self, request, product=None, **kwargs):
        ...
        label_field = form.base_fields["label"]
        ...
        label_field.empty_label = None
        label_field.queryset = LUT_ProductionMode.objects.filter(
            rght=F("lft") + 1,
            is_active=True,
            translations__language_code=translation.get_language(),
        ).order_by("translations__short_name")
