...
ORDER_PLANNED: str = "100"
ORDER_WAIT_FOR_OPEN: str = "200"
ORDER_OPENED: str = "300"
ORDER_WAIT_FOR_CLOSED: str = "350"
ORDER_CLOSED: str = "370"
ORDER_WAIT_FOR_SEND: str = "400"
ORDER_SEND: str = "500"
ORDER_WAIT_FOR_INVOICED: str = "600"
ORDER_WAIT_FOR_CANCEL_INVOICE: str = "700"
ORDER_INVOICED: str = "800"
ORDER_ARCHIVED: str = "900"
ORDER_CANCELLED: str = "950"

ORDER_PLANNED_STR: str = _("Scheduled")
ORDER_WAIT_FOR_OPEN_STR: str = _("Being opened")
ORDER_OPENED_STR: str = _("Orders opened")
ORDER_WAIT_FOR_CLOSED_STR: str = _("Being closed (step1)")
ORDER_CLOSED_STR: str = _("Being closed (step 2)")
ORDER_WAIT_FOR_SEND_STR: str = _("Being closed (step 3)")
ORDER_SEND_STR: str = _("Orders closed")
ORDER_WAIT_FOR_INVOICED_STR: str = _("Being invoiced")
ORDER_WAIT_FOR_CANCEL_INVOICE_STR: str = _("Being cancelled")
ORDER_INVOICED_STR: str = _("Invoiced")
ORDER_ARCHIVED_STR: str = _("Archived")
ORDER_CANCELLED_STR: str = _("Cancelled")

LUT_ORDER_STATUS = (
    (ORDER_PLANNED, ORDER_PLANNED_STR),
    (ORDER_WAIT_FOR_OPEN, ORDER_WAIT_FOR_OPEN_STR),
    (ORDER_OPENED, ORDER_OPENED_STR),
    (ORDER_WAIT_FOR_CLOSED, ORDER_WAIT_FOR_CLOSED_STR),
    (ORDER_CLOSED, ORDER_CLOSED_STR),
    (ORDER_WAIT_FOR_SEND, ORDER_WAIT_FOR_SEND_STR),
    (ORDER_SEND, ORDER_SEND_STR),
    (ORDER_WAIT_FOR_INVOICED, ORDER_WAIT_FOR_INVOICED_STR),
    (ORDER_WAIT_FOR_CANCEL_INVOICE, ORDER_WAIT_FOR_CANCEL_INVOICE_STR),
    (ORDER_INVOICED, ORDER_INVOICED_STR),
    (ORDER_ARCHIVED, ORDER_ARCHIVED_STR),
    (ORDER_CANCELLED, ORDER_CANCELLED_STR),
)
