...
from repanier_v2.auth_backend import RepanierAuthBackend
from repanier_v2.const import EMPTY_STRING
from repanier_v2.models.staff import Staff
from repanier_v2.tools import sint, get_repanier_template_name
...
def login_view(
    ...
    redirect_to = request.POST.get(
        redirect_field_name, request.GET.get(redirect_field_name, EMPTY_STRING)
    )
