...
from repanier_v2.tools import update_offer_item, next_row
from repanier_v2.xlsx.export_tools import *
from repanier_v2.xlsx.import_tools import get_row, get_header
...
def export_permanence_stock(
    ...
    if wb is not None:
        ...
        header = [
            ...
            (_("Initial stock"), 10),
            (repanier_v2.globals.REPANIER_SETTINGS_CURRENCY_DISPLAY, 15),
            (_("Stock used"), 10),
            (_("Additional"), 10),
...
#     error = False
#     error_msg = None
#     if permanence.status < ORDER_DONE:
