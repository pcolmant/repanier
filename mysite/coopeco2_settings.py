...
SITE_ID = 1
ALLOWED_HOSTS = ['coopeco2.be', 'coopeco2.repanier.local']
ROOT_URLCONF = 'coopeco2.urls'
WSGI_APPLICATION = 'coopeco2.wsgi.application'
...
REPANIER_SEND_ORDER_TO_BOARD = False
REPANIER_INVOICE = True
REPANIER_DISPLAY_ANONYMOUS_ORDER_FORM = True
REPANIER_DISPLAY_PRODUCERS_ON_ORDER_FORM = True
REPANIER_BANK_ACCOUNT = "BE31 3631 4515 2355"