...
### Site 6 specific parameters
SITE_ID = 1
ALLOWED_HOSTS = ['epidici.be', 'epidici.local']
EMAIL_SUBJECT_PREFIX = '[epidici.be]'
...
# REPANIER_PERMANENCE_NAME = gettext("Permanence")
REPANIER_PERMANENCE_NAME = gettext("Closure")
# REPANIER_PERMANENCES_NAME = gettext("Permanences")
REPANIER_PERMANENCES_NAME = gettext("Closures")
# REPANIER_PERMANENCE_ON_NAME = gettext("Permanence on ")
REPANIER_PERMANENCE_ON_NAME = gettext("Closure on ")
REPANIER_SEND_ORDER_TO_BOARD = True

REPANIER_DISPLAY_PRODUCERS_ON_ORDER_FORM = False
REPANIER_BANK_ACCOUNT = "'REPANIER_BANK_ACCOUNT' NON CONFIGURE..."